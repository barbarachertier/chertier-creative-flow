    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-10">
          <a href="#about" className="hover:text-gold-dark transition-colors">
            About
          </a>
          <a href="#experience" className="hover:text-gold-dark transition-colors">
            Experience
          </a>
          <a href="#skills" className="hover:text-gold-dark transition-colors">
            Skills
          </a>
          <a href="#portfolio" className="hover:text-gold-dark transition-colors">
            Portfolio
          </a>
      ...
      <div
        className={cn(
          "fixed inset-0 bg-beige-light/95 backdrop-blur-sm z-40 pt-24 px-6 flex flex-col items-center transition-transform duration-300 ease-in-out md:hidden",
